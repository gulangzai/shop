...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid"> 
	...
	<div class="col-sm-12" id="inside">
			...
			<!-- 检索  -->
			<form class="form-inline" width="100%" action="${ctx}/activitiCtrl/list.do" method="post" name="INDEX_Form" id="INDEX_Form" style="border:solid 1px #ddd;line-height:50px;vertical-align:middle;">
		...
		<%-- 	<table id="table_report" class="table table-striped table-bordered table-hover  imagetable">
				...
				<thead>
					<tr>
						...
						<th class="center"  style="text-align:center" width="10%">商品名</th>
						<th class="center"  style="text-align:center" width="50%">商品描述</th>
						<th class="center"  style="text-align:center" width="10%">商品价格</th>
						<th class="center"  style="text-align:center" width="10%">商品类型</th>
						<th class="center"  style="text-align:center" width="10%">是否特卖</th>
						<th class="center"  style="text-align:center" width="5%">操作</th>
					</tr>
				</thead> 				
				<tbody> 
				<!-- 开始循环 -->	
					...
					<c:when test="${not empty varList}"> 
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
							   ...
							   <p style="width:100px;">
							    <button type="button" class="btn btn-default btn-sm" onclick="edit('${var.F_PRODUCT_ID}');">
									<span class="glyphicon glyphicon-edit"></span>
								</button>
								
								<button type="button" class="btn btn-default btn-sm" onclick="del('${var.F_PRODUCT_ID}');">
									<span class="glyphicon glyphicon-remove"></span>
								</button>
                               </p>
								<!--	 <a  id="edit" style="cursor:pointer;" title="编辑" onclick="edit('${var.F_PRODUCT_ID}');" class="tooltip-success" data-rel="tooltip" title="" data-placement="left"><span class="green"><i class="icon-edit"></i></span>编辑</a> 
								     <a style="cursor:pointer;" title="删除" onclick="del('${var.F_PRODUCT_ID}');" class="tooltip-error" data-rel="tooltip" title="" data-placement="left"><span class="red"><i class="icon-trash"></i></span>删除</a> 
								  -->
								</td>  
							</tr>
 	...
 	<table id="jqGrid" class="table table-striped table-bordered table-hover imagetable" action="${ctx}/activitiCtrl/dataList.do">
		    <tr>
						<th class="center">
						<label><input type="checkbox" id="zcheckbox" /><span class="lbl"></span></label>
						</th> 
						<th name="ID_" align="center" width="5%">流程id</th>
						<th name="NAME_"  align="center"  width="10%">流程名</th>
						<th name="KEY_"  align="center" width="10%">流程关键字</th>
						<th name="CATEGORY_"       align="center"  width="10%">目录</th>
						<th name="CREATE_TIME_"   align="center"  width="10%" formatter="">创建时间</th>
						<th name="VERSION_"  align="center"  width="10%">版本</th>
       ...
       function doReportInfo(cellvalue, opts, rowObject){
    	...
    	/*	var showHtml ="<div class='hidden-sm hidden-xs action-buttons' style='padding-top:15px;'>";	
    		...
    		*/
    		...
    		showHtml +="<span class='glyphicon glyphicon-deploy'>部署</span>";
    		showHtml +="</button>";
