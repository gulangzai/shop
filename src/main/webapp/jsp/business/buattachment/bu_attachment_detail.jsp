             ...
             <form class="form-horizontal" action="${ctx}/buattachment/buAttachmentController/edit.do" role="form" name="Form" id="editForm" method="post">
           	 <input type="hidden" name="F_ADDRESS_UID" id="F_ADDRESS_UID" value="${pd.F_ADDRESS_UID}"/>
					       ...
					       <div class="form-group">
						          ...
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="ATTACHMENT_UID"  name="ATTACHMENT_UID"  value="${pd.ATTACHMENT_UID}"  placeholder="��������附件UID" title="附件UID">
						          </div>  
						       </div>
					       <div class="form-group">
						          <label class="col-sm-2 control-label">文件名:</label>
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="FILE_NAME"  name="FILE_NAME"  value="${pd.FILE_NAME}"  placeholder="��������文件名" title="文件名">
						          </div>  
						       </div>
					       <div class="form-group">
						          <label class="col-sm-2 control-label">文件扩展名:</label>
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="FILE_EXT_NAME"  name="FILE_EXT_NAME"  value="${pd.FILE_EXT_NAME}"  placeholder="��������文件扩展名" title="文件扩展名">
						          </div>  
						       </div>
					       <div class="form-group">
						          <label class="col-sm-2 control-label">文件地址:</label>
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="FILE_PATH"  name="FILE_PATH"  value="${pd.FILE_PATH}"  placeholder="��������文件地址" title="文件地址">
						          </div>  
						       </div>
					       <div class="form-group">
						          <label class="col-sm-2 control-label">文件的MIME_TYPE:</label>
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="MIME_TYPE"  name="MIME_TYPE"  value="${pd.MIME_TYPE}"  placeholder="��������文件的MIME_TYPE" title="文件的MIME_TYPE">
						          </div>  
						       </div>
					       <div class="form-group">
						          <label class="col-sm-2 control-label">文件大小:</label>
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="FILE_SIZE"  name="FILE_SIZE"  value="${pd.FILE_SIZE}"  placeholder="��������文件大小" title="文件大小">
						          </div>  
						       </div>
					       <div class="form-group">
