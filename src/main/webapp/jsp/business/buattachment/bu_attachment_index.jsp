...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid"> 
	<div class="col-sm-12" id="inside">
			...
			<form class="form-inline" width="100%" action="${ctx}/buattachment/buAttachmentController/list.do" method="post" name="INDEX_Form" id="INDEX_Form" style="border:solid 1px #ddd;line-height:50px;vertical-align:middle;">
		 	...
		 	<table id="jqGrid" class="table table-striped table-bordered table-hover imagetable"  action="${ctx}/buattachment/buAttachmentController/dataList.do">
		        
		        <tr>
		          
							    <th name="ATTACHMENT_UID"   align="center" formatter="">附件UID</th> 
							    <th name="FILE_NAME"   align="center" formatter="">文件名</th> 
							    <th name="FILE_EXT_NAME"   align="center" formatter="">文件扩展名</th> 
							    <th name="FILE_PATH"   align="center" formatter="">文件地址</th> 
							    <th name="MIME_TYPE"   align="center" formatter="">文件的MIME_TYPE</th> 
							    <th name="FILE_SIZE"   align="center" formatter="">文件大小</th> 
							    <th name="CREATE_DATE"   align="center" formatter="">创建时间</th> 
							    <th name="CREATE_USER"   align="center" formatter="">创建人</th> 
	...
	<!-- PAGE CONTENT ENDS HERE -->
       ...
       <script type="text/javascript">
		...
		function add(id){
		  ...
		  $.get("${ctx}/buattachment/buAttachmentController/goAddView.do?F_ADDRESS_UID="+id,function(data) {
		    	$("#edit-form").empty();
				$("#edit-form").html("");
				$("#edit-form").html(data);
			});
		...
		function edit(Id){
		    ...
		    $.get("${ctx}/buattachment/buAttachmentController/goEditView.do?F_ADDRESS_UID="+Id,function(data) {
				$("#edit-form").empty();
				$("#edit-form").html("");
				$("#edit-form").html(data);
			});   
	   ...
	   function see(Id){
		    ...
		    $.get("${ctx}/buattachment/buAttachmentController/goDetailView.do?F_ADDRESS_UID="+Id,function(data) {
				$("#edit-form").empty();
				$("#edit-form").html("");
				$("#edit-form").html(data);
			});   
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					...
					var url = "${ctx}/buattachment/buAttachmentController/delete.do?F_ADDRESS_UID="+Id+"&tm="+new Date().getTime();
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '${ctx}/buattachment/buAttachmentController/deleteAll.do?tm='+new Date().getTime(),
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		//导出excel
		function toExcel(){
			window.location.href='${ctx}/buattachment/buAttachmentController/excel.do';
		}
		</script>
