...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
      ...
      <div class="modal-body">
           <form class="form-horizontal" action="${ctx}/bucolor/buColorController/edit.do" role="form" name="Form" id="addForm" method="post">
 ...
 <script type="text/javascript">
	...
	function save(){
		...
		if(form.check()){
			$.ajax({
				url : "${ctx}/bucolor/buColorController/save.do",
