...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
	...
	<form class="form-horizontal"  action="${ctx}/goodClass/add.do" name="Form" id="Form_user_add" method="post">
  
        <input type="hidden" name="F_PClsId" id="F_PClsId" value="<%=F_ClsId%>">
      ...
      <div class="modal-footer">
         <button type="button" class="btn btn-default" id="addClose"
            data-dismiss="modal">关闭
         </button>
         <button type="button" class="btn btn-primary" id="add_save">
            提交更改
         </button>
      </div> 
   </div><!-- /.modal-content -->
 ...
 <script type="text/javascript"  src="${ctxStatic}/business/tbclass/js/tbclass_add.js"></script>   	
