...
<div class="modal-dialog width-70 height-auto">
   ...
   <p class="pop_title">修改风险源<span data-dismiss="modal"><img src='${ctx}/assets/img/close.png'></span> </p>
   <div id="information">
      <form id="tableEditForm">
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="execute_tableEdit" name="execute_tableEdit" > 
 	   <!-- 获取 项目 的 uid -->    	
      	  <input id="XCROJECT_UID" type="hidden" name="ROJECT_UID" fieldname="PROJECT_UID"  value="1"/> 
 
	  	  <input  type="hidden" name="FXY_UID"   fieldname="FXY_UID" value="<%=FXY_UID%>"/>       
          <input type="hidden" id="target_uid" fieldname="target_uid"/>
	  	  <input type="hidden" id="TARGET_TABLE" fieldname="TARGET_TABLE" value="PM_FXY" />	 	 		
	         ...
	         <div class='row'> 
			      ...
			      <input  type="text"  id ="FXY_TYPE"   disabled="disabled"    name="FXY_TYPE" fieldname="FXY_TYPE"  class='col-xs-4'/> 
                    <span class='col-xs-2'><b>*</b>危险因素分类</span> 
					<select id="execute_tableEdit_WXYS_FL"  type="text" class='col-xs-4'
			 ...
			 <div class="rowbox row">
					 ...
					 <span class="col-xs-2"><b class="ptop">*</b>危险因素</span>
			 		 ...
			 		 <textarea   nullmsg="请填写危险因素！"  placeholder="请填写危险因素！" type="text"  
			       ...
			       <div class='row'> 
						...
						<select id="execute_tableEdit_SHIGU"   type="text" class="col-xs-4"
						...
						<select id="execute_tableEdit_QUYU"
					...
					<div class="rowbox row"> 
						<span class="col-xs-2"><b class="ptop">*</b>控制措施</span> 
					      <textarea datatype="*" nullmsg="请填写控制措施！"  placeholder="请填写控制措施！" type="text"   class="col-xs-10" 
		       ...
		       <div class='row'> 
						<span class="col-xs-2"> 开始日期</span>
						 <input readonly="readonly"   data-date-format="yyyy-mm-dd"
							...
							name="BEGIN_DATE" id="execute_tableEdit_BEGIN_DATE" fieldname="BEGIN_DATE" class="REPORT_DATE1 col-xs-4">
						...
						<span class="col-xs-2"> 结束日期</span> <input readonly="readonly" data-date-format="yyyy-mm-dd"
							...
							name="END_DATE" id="execute_tableEdit_END_DATE" fieldname="END_DATE"  class="REPORT_DATE2 col-xs-4">
  ...
  <div class="modal_footer"> 
   	<span data-dismiss="modal" class="closeBtn" id="btnCloseXcJd">关闭</span>
	<span class="saveBtn" id="tableEditSave">保存</span>
  </div>
</div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/business/pmfxy/pm_fxy_edit.js"> </script>