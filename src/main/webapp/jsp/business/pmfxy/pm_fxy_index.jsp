		    ...
		    <!-- form 开始 位置 -->
				...
				<!--  <input id="PROJECT_UID" type="hidden" fieldname="t.PROJECT_UID" operation="="/>  -->
						...
						<select id="QUYU"
							...
							<input type="text" placeholder="危险因素"    name="t.WXYS" fieldname="a.WXYS" operation="=" logic="and">
							<input type="text" placeholder="可能导致的事故"  name="SHIGU" fieldname="a.SHIGU" id="SHIGU" operation="=" logic="and" >
							
							<input type="text" placeholder="开始时间" id="BEGIN_DATE" name="a.END_DATE" fieldname="a.END_DATE" operation=">=" logic="and" data-date-format="yyyy-mm-dd">
							<span></span>
							<input type="text" placeholder="结束时间" id="END_DATE" name="a.BEGIN_DATE " fieldname="a.BEGIN_DATE" operation="<=" logic="and" data-date-format="yyyy-mm-dd">
					  ...
					  <!--表格区--->
					    <table   sortname="a.FXY_UID" multiselect=false  rownum="10" sortorder="desc"  class=""  id="grid_table" 
