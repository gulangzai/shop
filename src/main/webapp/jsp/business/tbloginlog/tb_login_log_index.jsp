...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid"> 
	<div class="col-sm-12" id="inside">
			...
			<form class="form-inline" width="100%" action="${ctx}/tbloginlog/tbLoginLogController/dataList.do" method="post" name="INDEX_Form" id="INDEX_Form" style="border:solid 1px #ddd;line-height:50px;vertical-align:middle;">
		 	...
		 	<table id="jqGrid" class="table table-striped table-bordered table-hover imagetable"  action="${ctx}/tbloginlog/tbLoginLogController/dataList.do">
		        
		        <tr>
		            <th name="F_LOGIN_LOG_UID"   align="center" formatter="">日志编号</th>
				    <th name="userId"   align="center" formatter="">用户编号</th> 
				    <th name="F_UserName"   align="center" formatter="FUserNameFormatter">用户名</th> 
				    <th name="loginTime"   align="center" formatter="">登录时间</th> 
				    <th name="loginOut"   align="center" formatter="">登出时间</th>     
	...
	<!-- PAGE CONTENT ENDS HERE -->
	 ...
	 <script type="text/javascript" src="${ctxStatic}/business/tbloginlog/js/tbloginlog_list.js"> </script>
</html>
