...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
      ...
      <div class="modal-body">
           <form class="form-horizontal" action="${ctx}/tbmenu/tbMenuController/edit.do" role="form" name="Form" id="addForm" method="post">
                     
                       <input type="hidden" name="parent" id="parent" value="${pd.id}"/>  
...
<script type="text/javascript" src="${ctxStatic}/business/tbmenu/js/tbmenu_add.js"> </script>
