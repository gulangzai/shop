...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
      ...
      <div class="modal-body">
             <form class="form-horizontal" action="${ctx}/tbnotice/tbNoticeController/edit.do" role="form" name="Form" id="editForm" method="post">
 ...
 <script type="text/javascript" src="${ctxStatic}/business/tbnotice/js/tbnotice_edit.js"> </script>