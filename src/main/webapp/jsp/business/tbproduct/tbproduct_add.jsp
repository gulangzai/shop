...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
      ...
      <div class="modal-body">
           <form class="form-horizontal" action="${ctx}/tproductController/edit.do" role="form" name="Form" id="addForm" method="post">
           	 <input type="hidden" name="F_PRODUCT_ID" id="F_PRODUCT_ID" value="${pd.F_ProductId}"/>
		     <input type="hidden" name="F_CLSID" id="F_CLSID" value="${pd.F_CLSID}"/>
		     <input type="hidden" name="F_ISSPECIAL" id="F_IsSpecial" value="0"/>
			...
			<div class="form-group">
	          <label class="col-sm-2 control-label">商品数量:</label>
	           ...
	           <div class="col-sm-4">   
	            ...
	            <label  class="btn" onclick="classTree()">选择</label>
	       </div>
		   ...
		   <div class="form-group">
			      ...
			      <div class="col-sm-10">
			        <input   type="text" class="form-control"  name="F_PATH1" id="F_PATH1"   placeholder="这里输入商品URL1" title="商品URL">${pd.PATH1}</textarea>
			      </div>
		   </div>
		   ...
		   <div class="form-group">
			      ...
			      <div class="col-sm-10">
			        <input   type="text" class="form-control"  name="F_PATH2" id="F_PATH2"   placeholder="这里输入商品URL2" title="商品URL">${pd.PATH2}</textarea>
			      </div>
		   </div>
		   ...
		   <div class="form-group">
			      ...
			      <div class="col-sm-10">
			        <input   type="text" class="form-control"  name="F_PATH3" id="F_PATH3"   placeholder="这里输入商品URL3" title="商品URL">${pd.PATH3}</textarea>
			      </div>
		   </div>
		   ...
		   <div class="form-group">
			      ...
			      <div class="col-sm-10">
			        <input   type="text" class="form-control"  name="F_PATH4" id="F_PATH4"   placeholder="这里输入商品URL4" title="商品URL">${pd.PATH4}</textarea>
			      </div>
		   </div>
 ...
 <script type="text/javascript" src="${ctxStatic}/business/tbproduct/js/tbproduct_add.js"></script>