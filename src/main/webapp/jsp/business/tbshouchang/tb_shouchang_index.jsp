	...
	<!-- PAGE CONTENT ENDS HERE -->
       ...
       <script type="text/javascript">
		...
		function add(id){
		  ...
		  $.get("${ctx}/tbshouchang/tbShouchangController/goAddView.do?F_SHOUCHANG_UID="+id,function(data) {
		    	$("#edit-form").empty();
				$("#edit-form").html("");
				$("#edit-form").html(data);
			});
		...
		function edit(Id){
		    ...
		    $.get("${ctx}/tbshouchang/tbShouchangController/goEditView.do?F_SHOUCHANG_UID="+Id,function(data) {
				$("#edit-form").empty();
				$("#edit-form").html("");
				$("#edit-form").html(data);
			});   
	   ...
	   function see(Id){
		    ...
		    $.get("${ctx}/tbshouchang/tbShouchangController/goDetailView.do?F_SHOUCHANG_UID="+Id,function(data) {
				$("#edit-form").empty();
				$("#edit-form").html("");
				$("#edit-form").html(data);
			});   
