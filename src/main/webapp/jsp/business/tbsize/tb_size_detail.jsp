             ...
             <form class="form-horizontal" action="${ctx}/tbsize/tbSizeController/edit.do" role="form" name="Form" id="editForm" method="post">
           	 <input type="hidden" name="F_SIZE_UID" id="F_SIZE_UID" value="${pd.F_SIZE_UID}"/>
					       ...
					       <div class="form-group">
						          <label class="col-sm-2 control-label">尺寸UID:</label>
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="F_SIZE_UID"  name="F_SIZE_UID"  value="${pd.F_SIZE_UID}"  placeholder="��������尺寸UID" title="尺寸UID">
						          </div>  
						       </div>
					       <div class="form-group">
					       ...
					       <div class="form-group">
						          ...
						          <div class="col-sm-10">  
						             <input type="text" readOnly="readOnly" class="form-control" id="F_SIZE_LABEL"  name="F_SIZE_LABEL"  value="${pd.F_SIZE_LABEL}"  placeholder="��������尺寸名" title="尺寸名">
						          </div>  
						       </div>
					       <div class="form-group">
