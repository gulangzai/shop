...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
      ...
      <div class="modal-body">
             <form class="form-horizontal" action="${ctx}/tbuser/tbUserController/edit.do" role="form" name="Form" id="editForm" method="post">
           	 <input type="hidden" name="F_USER_ID" id="F_USER_ID" value="${pd.F_USER_ID}"/>
					  ...
					  <div class="form-group">
						          ...
						          <div class="col-sm-10">  
						             ...
						             nullmsg="请填写用户账号"
						             ajaxurl="${pageContext.request.contextPath}/tbuser/tbUserController?checkName&F_USER_ID=${pd.F_USER_ID}"  >
						          </div>  
						  </div>
						   ...
						   <div class="form-group">
						          ...
						          <div class="col-sm-10">  
						             <input type="password"
						             class="form-control" id="F_RealPassword"  
						             name="F_RealPassword"  
						             placeholder="请填写用户密码" title="用户密码"
					       ...
					       <div class="form-group">
						          ...
						          <div class="col-sm-10">  
						             <input  datatype="e" 
						             class="form-control" 
						             id="F_Email"  name="F_Email"      
						             placeholder="请填写用户邮箱" 
						             title="用户邮箱" 
						             nullmsg="请输入邮箱"
						             ajaxurl="${pageContext.request.contextPath}/tbuser/tbUserController?checkEmail&F_USER_ID=${pd.F_USER_ID}"
						             value="">
						             </input>
						          </div>  
						       </div>
						  ...
						  <div class="form-group">
						          ...
						          <div class="col-sm-10">  
						             ...
						             nullmsg="请输入手机号码"
						             ajaxurl="${pageContext.request.contextPath}/tbuser/tbUserController?checkMobile&F_USER_ID=${pd.F_USER_ID}" 
						             value="">
						             </input>
						          </div>  
						       </div>
 ...
 <script type="text/javascript" src="${ctxStatic}/business/tbuser/js/tbuser_edit.js"> </script>