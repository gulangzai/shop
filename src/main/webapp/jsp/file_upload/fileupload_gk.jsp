...
<script src="${pageContext.request.contextPath }/assets/sys_resources/plugins/file_upload/js/tmpl.min.js"></script>
...
$(function() {
 ...
 $('#fileupload').fileupload({
		...
		maxFileSize: 2000000000,//大小限制，20M
        url: url,//上传地址
        dataType: 'json',
