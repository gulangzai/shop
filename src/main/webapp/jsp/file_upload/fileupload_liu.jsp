...
String root = request.getScheme()+"://"+request.getServerName()+":"+Constants.getString("port", "8088")+"/file";
%>
	...
	for(var i=0;i<files.length;i++){
		...
		filee[1] = filee[1].toLowerCase();
			...
			if(file_type==undefined || file_type==file.FILE_TYPE){
					imgNum++;
					var showHtml="";
					showHtml +="<div  class='template-download' style='"+_width+"height:140px;float:left;'>";
					if(_miaoshu!="false"){	
					if(_quanxian=="true"){
							showHtml+="<div   style='"+_width+"height:140px;float:left; position: relative;'>"
							if(filee[1]=="rar"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/rar.png' class='hierarchy' />"
							}else if(filee[1]=="txt"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/txt.png' class='hierarchy' />"
							}else if(filee[1]=="pdf"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/pdf.png' class='hierarchy' />"
							}else if(filee[1]=="ppt" || filee[1]=="pptx"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/ppt.png' class='hierarchy' />"
							}else if(filee[1]=="xls" || filee[1]=="xlsx"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/excel.png' class='hierarchy' />"
							}else if(filee[1]=="doc" || filee[1]=="docx"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/word.png' class='hierarchy' />"
							}else if(filee[1]=="mp3"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/mp3.png' class='hierarchy' />"
							}else if(filee[1]=="mp4"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/mp4.png' class='hierarchy' />"
							}else if(filee[1]=="rm"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/rm.png' class='hierarchy' />"
							}else if(filee[1]=="wmv"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/wmv.png' class='hierarchy' />"
							}else if(filee[1]=="html"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/html.png' class='hierarchy' />"
							}else if(filee[1]=="psd"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/psd.png' class='hierarchy' />"
							}else if(filee[1]=="avi"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/avi.png' class='hierarchy' />"
							}else if(filee[1]=="dwg"){
							showHtml+="<img style='"+_width+"height:120px' src='${pageContext.request.contextPath }/assets/img/wendang3/dwg.png' class='hierarchy' />"
							}else{
							   if(file.MIME_TYPE.indexOf("image")!=-1 ||filee[1]=="bmp"){
							      showHtml+="<img style='"+_width+"height:120px' src='"+file.url+"' class='hierarchy' />"
							   }else{
							    showHtml+="<img style='"+_width+"height:120px'' src='${pageContext.request.contextPath }/assets/img/wendang3/qita.png' class='hierarchy' />"
                               }
							}
							showHtml+="<p class='ImgTitle'>"+file.FILE_NAME+"</p>"
							showHtml+="<div class='formText'>"
							showHtml+="<div class='formInner'>"
							if(file.MIME_TYPE.indexOf("image")!=-1){
							showHtml+="<a class='lightbox' href='<%=root%>"+file.FILE_PATH+"' >"
							showHtml+="<i class='ace-icon fa fa-search-plus'></i>"
							showHtml+="</a>"
							}
							showHtml+="<a href='"+file.url+"'>"
							showHtml+="<i class='ace-icon fa fa-cloud-download'></i></a>"
							if(_del=='true'){  
							showHtml+="<a class='my-del-btn' data-type='"+file.delete_type+"' data-url='"+file.delete_url+"&FILE_UID="+file.FILE_UID+"'>"
							...
							showHtml+="</div>";
							if(file.MIME_TYPE.indexOf("image")!=-1){
							showHtml+=" <p class='jiao'></p><div class='describe'><input type='hidden' fieldname='f_FILE_UID' value='"+file.FILE_UID+"'/><textarea  disabled='disabled'  fieldname='f_DESCRIPTION'>"+file.DESCRIPTION+"</textarea></div>"
						    }
						}
					}else{
						if(_quanxian=="true"){
