...
<base href="<%=basePath%>">
	...
	<!-- 即时通讯 -->
	<link rel="stylesheet" type="text/css" href="${ctx}/static/plugin/websocketInstantMsg/ext4/resources/css/ext-all.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/static/plugin/websocketInstantMsg/css/websocket.css" />
	<script type="text/javascript" src="${ctx}/static/plugin/websocketInstantMsg/ext4/ext-all-debug.js"></script>
	<script type="text/javascript" src="${ctx}/static/plugin/websocketInstantMsg/websocket.js"></script>
	<!-- 即时通讯 -->
...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<div id="main-content" class="clearfix">
			...
			<div style="padding-left: 70%;padding-top: 1px;">
				<div style="float: left;margin-top: 3px;"><img src="${ctx}/static/images/loadingi.gif" /> </div>
	...
	<!-- basic scripts -->
		...
		<script type="text/javascript" src="${ctx}/static/js/myjs/menusf.js"></script>
		
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${ctx}/static/js/myjs/index.js"></script>
</body>
</html>
