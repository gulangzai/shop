...
<script type="text/javascript" src="${ctxStatic}/business/tbuser/tbuser_list.js"> </script>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover  imagetable">
				...
				<thead>
					<tr>
						...
						<th class="center"  style="text-align:center">用户名</th>	
						<th class="center"  style="text-align:center">真实姓名</th>
						<th class="center"  style="text-align:center"  formatter="showSex()">性别</th>
						<th class="center"  style="text-align:center">邮件</th>
						<th class="center"  style="text-align:center">电话</th>
							   ...
							   <td  class="center" style="width:80px;">   
									...
									<a class='btn btn-mini btn-danger'   title="删除" onclick="del('${var.F_USER_ID}');">
									 ...
									 <p style="width:120px;">
									  ...
									  <button type="button" class="btn btn-default btn-sm" onclick="toRole('${var.F_UserName}');">
											<span class="glyphicon glyphicon-wrench"></span>
										</button>
										
									    <button type="button" class="btn btn-default btn-sm" onclick="edit('${var.F_USER_ID}');">
											<span class="glyphicon glyphicon-edit"></span>
										</button>
										
										<button type="button" class="btn btn-default btn-sm" onclick="del('${var.F_USER_ID}');">
